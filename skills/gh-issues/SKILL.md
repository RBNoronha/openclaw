---
name: gh-issues
description: "Busque problemas no GitHub, crie subagentes para implementar correções e abrir PRs, depois monitore e responda aos comentários de revisão de PR. Utilização: /gh-issues [owner/repo] [--label bug] [--limit 5] [--milestone v1.0] [--assignee @me] [--fork user/repo] [--watch] [--interval 5] [--reviews-only] [--cron] [--dry-run] [--model glm-5] [--notify-channel -1002381931352]"
user-invocable: true
metadata:
